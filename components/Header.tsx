  ...
  return (
    <header className="px-4 md:px-8 py-3.5 flex items-center justify-between bg-white border-b border-slate-100 sticky top-0 z-40 transition-all">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-slate-100 shadow-sm cursor-pointer hover:border-[#203267] transition-all">
           <img src="https://i.pravatar.cc/150?u=fluxa" alt="User" className="w-full h-full object-cover" />
        </div>
      </div>
